...
class s7(Scene):
    def construct(self):
        ...
        # ================= TITLE =================
        title = Text("Ловушка для гениев!", font=font_name, color=accent_color, line_spacing=1)\
        ...
        # ================= CENTER =================
        t25 = Text("25", font=font_name, color=accent_color, line_spacing=1).scale(0.6)
        t42 = Text("42", font=font_name, color=accent_color, line_spacing=1).scale(0.6)
        mult = Text("×", font=font_name, color=accent_color, line_spacing=1).scale(0.6)
        ...
        self.wait(3)
        # ================= TRANSFORM =================
        t5 = Text("5", font=font_name, color=accent_color, line_spacing=1).scale(0.75)
        t2 = Text("2", font=font_name, color=accent_color, line_spacing=1).scale(0.75)
        mult2 = Text("×", font=font_name, color=accent_color, line_spacing=1).scale(0.75)
        ...
        result10 = Text("= 10", font=font_name, color=text_color, line_spacing=1).scale(0.55)
        ...
        # ================= ANSWER 0 =================
        answer0 = Text("Ответ: 0", font=font_name, color=accent_color, line_spacing=1).scale(0.6)
        ...
        # ================= ANSWER 5 =================
        answer5 = Text("Ответ: 5", font=font_name, color=accent_color, line_spacing=1).scale(0.6)
