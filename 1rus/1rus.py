...
class s7(Scene):
    def construct(self):
        ...
        base = Text("2024", font=font_name, color=text_color)
        expo = Text("2025", font=font_name, color=text_color).scale(0.6)
        ...
        no_calc = Text(
            "Калькулятор не справится",
            font=font_name,
            color=text_color,
            line_spacing=1
        ).scale(0.5).shift(DOWN * 1.8)
        ...
        base2 = Text("2024", font=font_name, color=text_color)
        expo2 = Text("2025", font=font_name, color=text_color).scale(0.6)
